...
class CustomAdapter4(private val descp: Array<String?>, private val tipo: Array<String?>,private val imagenes: Array<String?>,private val tittles: Array<String?>, private val details: Array<String?>, private val context: Context?): RecyclerView.Adapter<CustomAdapter4.ViewHolder>() {
