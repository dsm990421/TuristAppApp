...
// TODO: Rename and change types of parameters
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        //Para mostrar los cards principales se creo un adapter con datos fijos y se agrego el metodo on clic listener
        //que redirige a Zona Activity
        super.onViewCreated(view, savedInstanceState)
        ...
        adapter.setOnItemClickListener(object : CustomAdapter2.onItemClickListener{
            override fun OnItemClick(position: Int) {
                val prefs = activity!!.getSharedPreferences("posicion_zona", Context.MODE_PRIVATE)
                var editor = prefs.edit()
                editor.putInt("posicion",position)
                editor.commit()

                startActivity(Intent(context, ZonaActivity::class.java))
            }
        })
